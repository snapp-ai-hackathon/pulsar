...
**پاسخ:**
- **متریک‌های فعلی**: روی دیتاست ۸ روزه، MAE در حدود X و RMSE در حدود Y است (مقادیر دقیق را از mlruns بخوانید).
- **مقایسه با baseline**: این متریک‌ها نسبت به baseline (مثلاً last value یا moving average) بهبود X% دارند.
